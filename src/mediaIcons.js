...
users.uniparse = {
  ...
  medias: [
    [getSvg('youtube'), 'https://youtube.com/channel/UCvNOch5x46MDaejgQ6SkzUg'],
    [getSvg('facebook'), 'https://facebook.com/UniParse'],
    [getSvg('instagram'), 'https://instagram.com/UniParse'],
    [getSvg('linkedin'), 'https://linkedin.com/in/UniParse'],
    [getSvg('github'), 'https://github.com/TheUniParse'],
    [getSvg('twitter'), 'https://twitter.com/UniParse']
  ],
}
...
users.mechid = {
  srcset: srcsetMechid,
  medias: [
    [getSvg('facebook'), 'https://facebook.com/got.em.11'],
    [getSvg('instagram'), 'https://instagram.com/mohamed_mchid_hedjala'],
    [getSvg('twitter'), 'https://twitter.com/mohamedmh06']
  ],
}

function attachMedias(ctx) {
